...
while ($row = mysqli_fetch_array($getEqName)) {
    $filepath = $_SERVER['DOCUMENT_ROOT']."/finalproject/assets/barcode/".$row['id']."_barcode.png"; //Get the filepath of where the image is going to be stored
...
$file = $_SERVER['DOCUMENT_ROOT'] . "/finalproject/assets/barcode/" . $eqID . "19_barcode.png";//get the file with the correct equipment ID
