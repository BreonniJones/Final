...
<!--                    <li class="nav-item" role="presentation"><a class="nav-link" href="index.php">Status</a></li>-->
                ...
                </ul><span class="navbar-text actions"> <a href="#returnModal" data-toggle="modal" class="login" data-backdrop="false" id="returnModalBtn">Return</a><a class="btn btn-light action-button" data-toggle="modal" role="button" href="#m" data-backdrop="false" id="checkoutModalBtn">Scan & Checkout</a></span></div>
        </div>
    </nav>
</div>
