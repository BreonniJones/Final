...
<div class="content">
    ...
    <div class="limiter" style="padding-top: 0;">
        ...
        <input type="checkbox" id="approved" name="approved" value="approved" style="margin-left: 5px"
                ...
                <div class="table100">
                    <table style="width: 100%">
                        ...
                        <tr class="table100-head">
                            ...
                            <th class="column7" style="border-bottom: 1px solid black">Action <br>(<a
                                        href='postverify.php?mode=0&redirecturl=<?php echo $_SERVER["REQUEST_URI"] ?>'
                                        style="font-weight: normal"><u>Verify All</u></a>)</th>
